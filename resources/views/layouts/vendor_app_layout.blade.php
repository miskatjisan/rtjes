                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="{{ route('vendor.info.create') }}">Details Add</a>
                                        <a href="{{ route('vendor.info.index') }}">Vendor Details</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="{{ route('vendor.order-details.index') }}">All Order</a>
                                    </li>
                             ...
                             <li>
                                    ...
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li>
                                            <a href="{{ route('vendor.product-add.create') }}">Add Product</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('vendor.product-add.index') }}">Product List</a>
                                        </li>
                                    </ul>
                            </li>
